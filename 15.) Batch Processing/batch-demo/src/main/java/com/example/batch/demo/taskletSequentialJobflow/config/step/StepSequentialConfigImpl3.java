...
@Service("StepSequentialConfigImpl3")
@Slf4j
public class StepSequentialConfigImpl3 implements StepConfig {
    private final StepBuilderFactory stepBuilderFactory;

    public StepSequentialConfigImpl3(StepBuilderFactory stepBuilderFactory) {
        this.stepBuilderFactory = stepBuilderFactory;
    }

    @Override
    public Step myTaskletStep() {
        return stepBuilderFactory.get("myStep-3").tasklet((stepContribution, chunkContext) -> {
