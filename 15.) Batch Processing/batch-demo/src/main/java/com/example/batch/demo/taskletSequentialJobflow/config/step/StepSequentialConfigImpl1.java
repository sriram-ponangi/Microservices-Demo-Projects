...
@Service("StepSequentialConfigImpl1")
@Slf4j
public class StepSequentialConfigImpl1 implements StepConfig {
    private final StepBuilderFactory stepBuilderFactory;

    public StepSequentialConfigImpl1(StepBuilderFactory stepBuilderFactory) {
        this.stepBuilderFactory = stepBuilderFactory;
    }

    @Override
    public Step myTaskletStep() {
        return stepBuilderFactory.get("myStep-1").tasklet((stepContribution, chunkContext) -> {
