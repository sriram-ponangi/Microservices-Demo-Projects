...
@Service("StepConditionalConfigImpl3")
@Slf4j
public class StepConditionalConfigImpl3 implements StepConfig {
    private final StepBuilderFactory stepBuilderFactory;

    public StepConditionalConfigImpl3(StepBuilderFactory stepBuilderFactory) {
        this.stepBuilderFactory = stepBuilderFactory;
    }

    @Override
    public Step myTaskletStep() {
        return stepBuilderFactory.get("myConditionalStep-3").tasklet((stepContribution, chunkContext) -> {
